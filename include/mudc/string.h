...
#define strbuf_new(a, capacity, strlike) _Generic((strlike), \
    ...
    struct StrBuf: strbuf_new_strbuf(a, capacity, strlike), \
    struct Str: strbuf_new_str(a, capacity, strlike)
...
#define str_new(strlike) _Generic((strlike), \
    ...
    struct StrBuf: str_new_strbuf(strlike), \
    struct Str: str_new_str(strlike)
